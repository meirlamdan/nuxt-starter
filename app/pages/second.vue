...
<template>
  <div>
    <UContainer>
      <h1 class="text-5xl font-medium text-center">Second Page</h1>
      <div class="mt-16 text-2xl text-center text-gray-600">important links</div>
      <div class="flex justify-center flex-wrap gap-5 text-lg mt-5">
        <NuxtLink class="flex items-center gap-1" to="https://nuxt.com/">nuxt
          <UIcon name="i-logos-nuxt-icon" />
        </NuxtLink>
        <NuxtLink class="flex items-center gap-1" to="https://ui3.nuxt.dev/">
          <svg viewBox="0 0 1020 200" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-[18px] shrink-0">
            <path
        ...
        <NuxtLink class="flex items-center gap-1" to="https://tailwindcss.com/">tailwind
          <UIcon name="i-logos-tailwindcss-icon" />
        </NuxtLink>
        <NuxtLink class="flex items-center gap-1" to="https://nuxt.com/docs/guide/concepts/typescript">typescript
          <UIcon name="i-logos-typescript-icon" />
        </NuxtLink>
        <NuxtLink class="flex items-center gap-1" to="https://nitro.build/">nitro
          <UIcon name="unjs:nitro" />
        </NuxtLink>
        <NuxtLink class="flex items-center gap-1" to="https://orm.drizzle.team/docs">drizzle orm
          <UIcon name="i-simple-icons-drizzle" />
        </NuxtLink>
      </div>
    </UContainer>
  </div>
